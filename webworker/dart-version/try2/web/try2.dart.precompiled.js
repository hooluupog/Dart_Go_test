...
_CustomizedZone: {"": "Object;parent>,_specification<,_liblib3$_map",
...
InputElement: {"": "HtmlElement;name=,value=", $isElement: true, $isNode: true},
...
ScriptElement: {"": "SvgElement;", $isScriptElement: true},
...
main: function() {
  var t1, worker, runbutton, t2, t3, t4, clearbutton;
  t1 = {};
  worker = H.IsolateNatives_spawn(null, "hanoi.dart", false);
  P._Isolate_port()._callback = new O.main_closure(worker);
  t1.disknum_0 = 8;
  ...
  t4 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._EventStreamSubscription__wrapZone(new O.main_closure0(t1, worker)), t3._useCapture);
  ...
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._EventStreamSubscription__wrapZone(new O.main_closure1(t1)), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
},

main_closure: {"": "Closure;worker_1",
  call$2: function(msg, reply) {
    ...
    if (J.$eq(msg, "Over")) {
      ...
      t2 = P._Isolate_port();
      t2.toSendPort$0;
      t1.send$2(t1, "OK", new H._NativeJsSendPort(t2, $globalState.currentContext.id));
    } else {
      ...
      if (typeof t3 !== "string")
        throw t3.$add();
      t2.set$innerHtml(t1, C.JSString_methods.$add(t3, msg));
    }
  }
},

main_closure0: {"": "Closure;box_0,worker_2",
  call$1: function(e) {
    var t1, t2, t3;
    t1 = this.box_0;
    ...
    t3 = P._Isolate_port();
    t3.toSendPort$0;
    t2.send$2(t2, t1, new H._NativeJsSendPort(t3, $globalState.currentContext.id));
  }
},
...
// Native classes
H.defineNativeMethods("DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList", J.Interceptor);
...
function dart_precompiled($collectedClasses) {
  ...
  function _CustomizedZone(parent, _specification, _liblib3$_map) {
    this.parent = parent;
    this._specification = _specification;
    this._liblib3$_map = _liblib3$_map;
  }
  ...
  function HashMapKeyIterator(_map, _liblib1$_keys, _offset, _liblib1$_current) {
    this._map = _map;
    this._liblib1$_keys = _liblib1$_keys;
  ...
  function _LinkedHashSet(_liblib1$_length, _strings, _nums, _rest, _first, _last, _modifications) {
    this._liblib1$_length = _liblib1$_length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
  ...
  function LinkedHashSetCell(_liblib1$_element, _next, _previous) {
    this._liblib1$_element = _liblib1$_element;
    this._next = _next;
    this._previous = _previous;
  }
  ...
  LinkedHashSetCell.prototype.get$_liblib1$_element = function() {
  ...
  function LinkedHashSetIterator(_set, _modifications, _cell, _liblib1$_current) {
    this._set = _set;
    this._modifications = _modifications;
    this._cell = _cell;
    this._liblib1$_current = _liblib1$_current;
  ...
  function main_closure(worker_1) {
    this.worker_1 = worker_1;
  }
  ...
  function main_closure0(box_0, worker_2) {
    this.box_0 = box_0;
