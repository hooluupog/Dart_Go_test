...
$$.BoundClosure$1 = [W, {"": "BoundClosure;_self,_liblib0$_target,_receiver,_liblib0$_name",
  call$1: function(p0) {
...
$$.Closure$fetch_text = [O, {"": "Closure;call$0,$name", $is_void_: true}];
...
_BufferingSendPort_closure: {"": "Closure;this_0",
  call$1: function(p) {
    var t1, t2, t3, item, t4;
    t1 = this.this_0;
    t1._port = p;
    for (t2 = t1.pending, t2 = new H.ListIterator(t2, t2.length, 0, null), t3 = J.getInterceptor$x(p); t2.moveNext$0();) {
      item = t2._current;
      t4 = J.getInterceptor$asx(item);
      t3.send$2(p, t4.$index(item, "message"), t4.$index(item, "replyTo"));
    }
    t1.pending = null;
  }
},
...
_HashSet: {"": "_HashSetBase;_liblib1$_length,_strings,_nums,_rest,_elements",
  get$iterator: function(_) {
...
Console: {"": "Object;",
  ...
  get$count: function() {
    return new W.BoundClosure$1(this, W.Console.prototype.count$1, null, "count$1");
  },
  static: {
...
FEBlendElement: {"": "SvgElement;x="},

FEColorMatrixElement: {"": "SvgElement;x="},

FEComponentTransferElement: {"": "SvgElement;x="},

FECompositeElement: {"": "SvgElement;x="},

FEConvolveMatrixElement: {"": "SvgElement;x="},

FEDiffuseLightingElement: {"": "SvgElement;x="},

FEDisplacementMapElement: {"": "SvgElement;x="},

FEFloodElement: {"": "SvgElement;x="},

FEGaussianBlurElement: {"": "SvgElement;x="},

FEImageElement: {"": "SvgElement;x="},

FEMergeElement: {"": "SvgElement;x="},

FEMorphologyElement: {"": "SvgElement;x="},

FEOffsetElement: {"": "SvgElement;x="},

FEPointLightElement: {"": "SvgElement;x=,z="},

FESpecularLightingElement: {"": "SvgElement;x="},

FESpotLightElement: {"": "SvgElement;x=,z="},

FETileElement: {"": "SvgElement;x="},

FETurbulenceElement: {"": "SvgElement;x="},

FilterElement: {"": "SvgElement;x="},

ForeignObjectElement: {"": "GraphicsElement;x="},

GraphicsElement: {"": "SvgElement;"},

ImageElement0: {"": "GraphicsElement;x="},

MaskElement: {"": "SvgElement;x="},

PatternElement: {"": "SvgElement;x="},

RectElement: {"": "GraphicsElement;x="},
...
SvgSvgElement: {"": "GraphicsElement;x="},

TextContentElement: {"": "GraphicsElement;"},

TextPositioningElement: {"": "TextContentElement;x="},

UseElement: {"": "GraphicsElement;x="}}],
...
["try2.dart", "try2.dart", , O, {
view: function() {
  var t1, runbutton, t2, t3, t4, clearbutton;
  t1 = {};
  t1.disknum_0 = 0;
  document.querySelector("#title_id").textContent = "Tower Of Hanoi disk numbers = " + t1.disknum_0;
  runbutton = document.querySelector("#run");
  runbutton.get$onClick;
  t2 = C.EventStreamProvider_click._eventType;
  t3 = new W._ElementEventStreamImpl(runbutton, t2, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t4 = new W._EventStreamSubscription(0, t3._target, t3._eventType, new O.view_closure(t1), t3._useCapture);
  H.setRuntimeTypeInfo(t4, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t4._tryResume$0();
  clearbutton = document.querySelector("#clear");
  clearbutton.get$onClick;
  t2 = new W._ElementEventStreamImpl(clearbutton, t2, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, new O.view_closure0(t1), t2._useCapture);
...
send_text: function(count, n, x, z) {
  H.IsolateNatives_spawnFunction(O.fetch_text$closure).call$1(new O.Message(count, n, x, z)).then$1(new O.send_text_closure());
},

fetch_text: function() {
  P._Isolate_port()._callback = new O.fetch_text_closure();
},
...
view_closure: {"": "Closure;box_0",
  call$1: function(e) {
    var sw, t1, t2, t3, t4;
    sw = new P.Stopwatch(null, null);
    sw.start$0(sw);
    t1 = this.box_0;
    t1.disknum_0 = t1.disknum_0 + 1;
    document.querySelector("#title_id").textContent = "Tower Of Hanoi disk numbers = " + t1.disknum_0;
    O.hanoi(t1.disknum_0, "A", "B", "C");
    sw.stop$0(sw);
    H.Primitives_printString(H.S(C.JSNumber_methods.$tdiv(sw.get$elapsedTicks() * 1000, 1000000)) + "ms.");
    t1 = document.querySelector("#sample_text_id");
    t2 = J.getInterceptor$x(t1);
    t3 = t2.get$innerHtml(t1);
    t4 = "<li>time used: " + H.S(C.JSNumber_methods.$tdiv(sw.get$elapsedTicks() * 1000, 1000000)) + "ms.</li>";
    if (t3 == null)
      throw t3.$add();
...
view_closure0: {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    t1.disknum_0 = 0;
    document.querySelector("#title_id").textContent = "Tower Of Hanoi disk numbers = " + t1.disknum_0;
    J.set$innerHtml$x(document.querySelector("#sample_text_id"), "");
  }
},

Message: {"": "Object;count<,n<,x>,z>"},

send_text_closure: {"": "Closure;",
  call$1: function(reply) {
    ...
    if (typeof t3 !== "string")
      throw t3.$add();
    t2.set$innerHtml(t1, C.JSString_methods.$add(t3, reply));
  }
},

fetch_text_closure: {"": "Closure;",
  call$2: function(msg, reply) {
    var t1 = J.getInterceptor$x(msg);
    J.send$1$x(reply, "<li>" + H.S(msg.get$count()) + ".move disk " + msg.get$n() + " from " + H.S(t1.get$x(msg)) + " to " + H.S(t1.get$z(msg)) + "</li>");
  }
}},
1],
]);
...
init.globalFunctions.fetch_text$closure = O.fetch_text$closure = new O.Closure$fetch_text(O.fetch_text, "fetch_text$closure");
...
function dart_precompiled($collectedClasses) {
  ...
  function IsolateNatives__startNonWorker_closure(functionName_0, replyPort_1) {
    this.functionName_0 = functionName_0;
    this.replyPort_1 = replyPort_1;
  }
  ...
  function _BufferingSendPort(_id, _port, _futurePort, pending, _isolateId) {
    this._id = _id;
    this._port = _port;
  ...
  function LinkedHashMapCell(_key, _liblib1$_value, _next, _previous) {
    this._key = _key;
    this._liblib1$_value = _liblib1$_value;
    this._next = _next;
  ...
  LinkedHashMapCell.prototype.get$_liblib1$_value = function() {
    return this._liblib1$_value;
  };
  LinkedHashMapCell.prototype.set$_liblib1$_value = function(v) {
    return this._liblib1$_value = v;
  };
  ...
  function _HashSet(_liblib1$_length, _strings, _nums, _rest, _elements) {
    this._liblib1$_length = _liblib1$_length;
    this._strings = _strings;
    this._nums = _nums;
    this._rest = _rest;
  ...
  function _ListQueueIterator(_queue, _end, _modificationCount, _position, _liblib1$_current) {
    this._queue = _queue;
    this._end = _end;
    this._modificationCount = _modificationCount;
  ...
  Message.prototype.get$count = function() {
    return this.count;
  };
  Message.prototype.get$n = function() {
    return this.n;
  };
  Message.prototype.get$x = function(receiver) {
    return this.x;
  };
  Message.prototype.get$z = function(receiver) {
    return this.z;
  };
  function send_text_closure() {
  }
  send_text_closure.builtin$cls = "send_text_closure";
  if (!"name" in send_text_closure)
    send_text_closure.name = "send_text_closure";
  $desc = $collectedClasses.send_text_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  send_text_closure.prototype = $desc;
  function fetch_text_closure() {
  }
  fetch_text_closure.builtin$cls = "fetch_text_closure";
  if (!"name" in fetch_text_closure)
    fetch_text_closure.name = "fetch_text_closure";
  $desc = $collectedClasses.fetch_text_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  fetch_text_closure.prototype = $desc;
  ...
  function Closure$fetch_text(call$0, $name) {
    this.call$0 = call$0;
    this.$name = $name;
  }
  Closure$fetch_text.builtin$cls = "Closure$fetch_text";
  $desc = $collectedClasses.Closure$fetch_text;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Closure$fetch_text.prototype = $desc;
